...
// Neurons: 5, Edges: 5, Threshold levels: 1
...
module N2
  ...
  // Normal period - firing on newP (1 levels, no reset tick)
  // Level 0: newP_N2 <= 6 -> no fire
  [tick] newP_N2 <= 6 -> (y_N2' = 0) & (p_N2' = newP_N2);
  // Level 1: newP_N2 > 6 -> certain fire
...
module N3
  ...
  // Normal period - firing on newP (1 levels, no reset tick)
  // Level 0: newP_N3 <= 6 -> no fire
  [tick] newP_N3 <= 6 -> (y_N3' = 0) & (p_N3' = newP_N3);
  // Level 1: newP_N3 > 6 -> certain fire
...
module N4
  ...
  // Normal period - firing on newP (1 levels, no reset tick)
  // Level 0: newP_N4 <= 6 -> no fire
  [tick] newP_N4 <= 6 -> (y_N4' = 0) & (p_N4' = newP_N4);
  // Level 1: newP_N4 > 6 -> certain fire
