...
const int P_MAX_N4 = 16;  // T_d + max_excitatory_input
...
const int W_N1_N3 = 5;  // delta_6(80)
const int W_N2_N4 = 5;  // delta_6(80)
const int W_N3_N4 = 5;  // delta_6(80)
...
module N3
  ...
  // Level 1: 1 < newP_N3 <= 3 -> fire P=0.25
  [tick] newP_N3 > 1 & newP_N3 <= 3 -> 0.250000:(y_N3' = 1) & (p_N3' = 0) + 0.750000:(y_N3' = 0) & (p_N3' = newP_N3);
  // Level 2: 3 < newP_N3 <= 4 -> fire P=0.50
  [tick] newP_N3 > 3 & newP_N3 <= 4 -> 0.500000:(y_N3' = 1) & (p_N3' = 0) + 0.500000:(y_N3' = 0) & (p_N3' = newP_N3);
  // Level 3: 4 < newP_N3 <= 6 -> fire P=0.75
  [tick] newP_N3 > 4 & newP_N3 <= 6 -> 0.750000:(y_N3' = 1) & (p_N3' = 0) + 0.250000:(y_N3' = 0) & (p_N3' = newP_N3);
  // Level 4: newP_N3 > 6 -> certain fire
  [tick] newP_N3 > 6 -> 1.0:(y_N3' = 1) & (p_N3' = 0);
...
module N4
  ...
  // Normal period - firing on newP (4 levels, no reset tick)
  // Level 0: newP_N4 <= 1 -> no fire
  [tick] newP_N4 <= 1 -> (y_N4' = 0) & (p_N4' = newP_N4);
  // Level 1: 1 < newP_N4 <= 3 -> fire P=0.25
  [tick] newP_N4 > 1 & newP_N4 <= 3 -> 0.250000:(y_N4' = 1) & (p_N4' = 0) + 0.750000:(y_N4' = 0) & (p_N4' = newP_N4);
  // Level 2: 3 < newP_N4 <= 4 -> fire P=0.50
  [tick] newP_N4 > 3 & newP_N4 <= 4 -> 0.500000:(y_N4' = 1) & (p_N4' = 0) + 0.500000:(y_N4' = 0) & (p_N4' = newP_N4);
  // Level 3: 4 < newP_N4 <= 6 -> fire P=0.75
  [tick] newP_N4 > 4 & newP_N4 <= 6 -> 0.750000:(y_N4' = 1) & (p_N4' = 0) + 0.250000:(y_N4' = 0) & (p_N4' = newP_N4);
  // Level 4: newP_N4 > 6 -> certain fire
  [tick] newP_N4 > 6 -> 1.0:(y_N4' = 1) & (p_N4' = 0);
