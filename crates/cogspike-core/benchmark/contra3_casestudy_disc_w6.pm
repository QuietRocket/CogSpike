...
// Weight discretization: WL=6, T_d=5, r=0.5
...
const int T_d = 5;      // Discretized threshold (paper section 3.2)
...
const int P_MIN_N1 = -8;  // sum of inhibitory inputs
const int P_MAX_N2 = 11;  // T_d + max_excitatory_input
const int P_MIN_N2 = -10;  // sum of inhibitory inputs
const int P_MAX_N3 = 11;  // T_d + max_excitatory_input
const int P_MIN_N3 = -10;  // sum of inhibitory inputs
const int P_MAX_O1 = 11;  // T_d + max_excitatory_input
const int P_MIN_O1 = 0;  // sum of inhibitory inputs
const int P_MAX_O2 = 11;  // T_d + max_excitatory_input
const int P_MIN_O2 = 0;  // sum of inhibitory inputs
const int P_MAX_O3 = 11;  // T_d + max_excitatory_input
const int P_MIN_O3 = 0;  // sum of inhibitory inputs
const int T_MAX = 100;

// Discretized synaptic weights (paper section 3)
const int W_S1_N1 = 6;  // delta_6(100)
const int W_S2_N2 = 6;  // delta_6(100)
const int W_S3_N3 = 6;  // delta_6(100)
const int W_N1_O1 = 6;  // delta_6(100)
const int W_N2_O2 = 6;  // delta_6(100)
const int W_N3_O3 = 6;  // delta_6(100)
const int W_N1_N2 = -6;  // delta_6(-100)
const int W_N1_N3 = -6;  // delta_6(-100)
const int W_N2_N1 = -4;  // delta_6(-70)
const int W_N2_N3 = -4;  // delta_6(-70)
const int W_N3_N1 = -4;  // delta_6(-70)
const int W_N3_N2 = -4;  // delta_6(-70)
...
module N1
  ...
  // Level 1: 1 < newP_N1 <= 2 -> fire P=0.25
  [tick] newP_N1 > 1 & newP_N1 <= 2 -> 0.250000:(y_N1' = 1) & (p_N1' = 0) + 0.750000:(y_N1' = 0) & (p_N1' = newP_N1);
  // Level 2: 2 < newP_N1 <= 3 -> fire P=0.50
  [tick] newP_N1 > 2 & newP_N1 <= 3 -> 0.500000:(y_N1' = 1) & (p_N1' = 0) + 0.500000:(y_N1' = 0) & (p_N1' = newP_N1);
  // Level 3: 3 < newP_N1 <= 5 -> fire P=0.75
  [tick] newP_N1 > 3 & newP_N1 <= 5 -> 0.750000:(y_N1' = 1) & (p_N1' = 0) + 0.250000:(y_N1' = 0) & (p_N1' = newP_N1);
  // Level 4: newP_N1 > 5 -> certain fire
...
module N2
  ...
  // Level 1: 1 < newP_N2 <= 2 -> fire P=0.25
  [tick] newP_N2 > 1 & newP_N2 <= 2 -> 0.250000:(y_N2' = 1) & (p_N2' = 0) + 0.750000:(y_N2' = 0) & (p_N2' = newP_N2);
  // Level 2: 2 < newP_N2 <= 3 -> fire P=0.50
  [tick] newP_N2 > 2 & newP_N2 <= 3 -> 0.500000:(y_N2' = 1) & (p_N2' = 0) + 0.500000:(y_N2' = 0) & (p_N2' = newP_N2);
  // Level 3: 3 < newP_N2 <= 5 -> fire P=0.75
  [tick] newP_N2 > 3 & newP_N2 <= 5 -> 0.750000:(y_N2' = 1) & (p_N2' = 0) + 0.250000:(y_N2' = 0) & (p_N2' = newP_N2);
  // Level 4: newP_N2 > 5 -> certain fire
...
module N3
  ...
  // Normal period - firing on newP (4 levels, no reset tick)
  // Level 0: newP_N3 <= 1 -> no fire
  [tick] newP_N3 <= 1 -> (y_N3' = 0) & (p_N3' = newP_N3);
  // Level 1: 1 < newP_N3 <= 2 -> fire P=0.25
  [tick] newP_N3 > 1 & newP_N3 <= 2 -> 0.250000:(y_N3' = 1) & (p_N3' = 0) + 0.750000:(y_N3' = 0) & (p_N3' = newP_N3);
  // Level 2: 2 < newP_N3 <= 3 -> fire P=0.50
  [tick] newP_N3 > 2 & newP_N3 <= 3 -> 0.500000:(y_N3' = 1) & (p_N3' = 0) + 0.500000:(y_N3' = 0) & (p_N3' = newP_N3);
  // Level 3: 3 < newP_N3 <= 5 -> fire P=0.75
  [tick] newP_N3 > 3 & newP_N3 <= 5 -> 0.750000:(y_N3' = 1) & (p_N3' = 0) + 0.250000:(y_N3' = 0) & (p_N3' = newP_N3);
  // Level 4: newP_N3 > 5 -> certain fire
...
module O1
  ...
  // Normal period - firing on newP (4 levels, no reset tick)
  // Level 0: newP_O1 <= 1 -> no fire
  [tick] newP_O1 <= 1 -> (y_O1' = 0) & (p_O1' = newP_O1);
  // Level 1: 1 < newP_O1 <= 2 -> fire P=0.25
  [tick] newP_O1 > 1 & newP_O1 <= 2 -> 0.250000:(y_O1' = 1) & (p_O1' = 0) + 0.750000:(y_O1' = 0) & (p_O1' = newP_O1);
  // Level 2: 2 < newP_O1 <= 3 -> fire P=0.50
  [tick] newP_O1 > 2 & newP_O1 <= 3 -> 0.500000:(y_O1' = 1) & (p_O1' = 0) + 0.500000:(y_O1' = 0) & (p_O1' = newP_O1);
  // Level 3: 3 < newP_O1 <= 5 -> fire P=0.75
  [tick] newP_O1 > 3 & newP_O1 <= 5 -> 0.750000:(y_O1' = 1) & (p_O1' = 0) + 0.250000:(y_O1' = 0) & (p_O1' = newP_O1);
  // Level 4: newP_O1 > 5 -> certain fire
...
module O2
  ...
  // Normal period - firing on newP (4 levels, no reset tick)
  // Level 0: newP_O2 <= 1 -> no fire
  [tick] newP_O2 <= 1 -> (y_O2' = 0) & (p_O2' = newP_O2);
  // Level 1: 1 < newP_O2 <= 2 -> fire P=0.25
  [tick] newP_O2 > 1 & newP_O2 <= 2 -> 0.250000:(y_O2' = 1) & (p_O2' = 0) + 0.750000:(y_O2' = 0) & (p_O2' = newP_O2);
  // Level 2: 2 < newP_O2 <= 3 -> fire P=0.50
  [tick] newP_O2 > 2 & newP_O2 <= 3 -> 0.500000:(y_O2' = 1) & (p_O2' = 0) + 0.500000:(y_O2' = 0) & (p_O2' = newP_O2);
  // Level 3: 3 < newP_O2 <= 5 -> fire P=0.75
  [tick] newP_O2 > 3 & newP_O2 <= 5 -> 0.750000:(y_O2' = 1) & (p_O2' = 0) + 0.250000:(y_O2' = 0) & (p_O2' = newP_O2);
  // Level 4: newP_O2 > 5 -> certain fire
...
module O3
  ...
  // Normal period - firing on newP (4 levels, no reset tick)
  // Level 0: newP_O3 <= 1 -> no fire
  [tick] newP_O3 <= 1 -> (y_O3' = 0) & (p_O3' = newP_O3);
  // Level 1: 1 < newP_O3 <= 2 -> fire P=0.25
  [tick] newP_O3 > 1 & newP_O3 <= 2 -> 0.250000:(y_O3' = 1) & (p_O3' = 0) + 0.750000:(y_O3' = 0) & (p_O3' = newP_O3);
  // Level 2: 2 < newP_O3 <= 3 -> fire P=0.50
  [tick] newP_O3 > 2 & newP_O3 <= 3 -> 0.500000:(y_O3' = 1) & (p_O3' = 0) + 0.500000:(y_O3' = 0) & (p_O3' = newP_O3);
  // Level 3: 3 < newP_O3 <= 5 -> fire P=0.75
  [tick] newP_O3 > 3 & newP_O3 <= 5 -> 0.750000:(y_O3' = 1) & (p_O3' = 0) + 0.250000:(y_O3' = 0) & (p_O3' = newP_O3);
  // Level 4: newP_O3 > 5 -> certain fire
