...
const int w_N1_N3 = 80;
const int w_N2_N4 = 80;
...
formula newPotential_N3 = max(P_MIN_N3, min(P_MAX_N3, floor((w_N1_N3 * y_N1) + r * p_N3)));
formula newPotential_N4 = max(P_MIN_N4, min(P_MAX_N4, floor((w_N2_N4 * y_N2 + w_N3_N4 * y_N3) + r * p_N4)));
...
module N2
  ...
  [tick] newPotential_N2 > threshold1 -> 1.0:(y_N2' = 1) & (p_N2' = P_reset);
...
module N3
  ...
  [tick] newPotential_N3 > threshold1 -> 1.0:(y_N3' = 1) & (p_N3' = P_reset);
...
module N4
  ...
  [tick] newPotential_N4 > threshold1 -> 1.0:(y_N4' = 1) & (p_N4' = P_reset);
