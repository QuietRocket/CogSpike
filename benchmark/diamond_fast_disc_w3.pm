...
// Neurons: 5, Edges: 5, Threshold levels: 4
...
const int P_MAX_N4 = 7;  // T_d + max_excitatory_input
...
const int W_N1_N3 = 2;  // delta_3(80)
const int W_N2_N4 = 2;  // delta_3(80)
...
formula contrib_N3 = W_N1_N3 * y_N1;
formula contrib_N4 = W_N2_N4 * y_N2 + W_N3_N4 * y_N3;
...
module N4
  ...
  // Normal period - firing on newP (4 levels, no reset tick)
  // Level 0: newP_N4 <= 0 -> no fire
  [tick] newP_N4 <= 0 -> (y_N4' = 0) & (p_N4' = newP_N4);
  // Level 1: 0 < newP_N4 <= 1 -> fire P=0.25
  [tick] newP_N4 > 0 & newP_N4 <= 1 -> 0.250000:(y_N4' = 1) & (p_N4' = 0) + 0.750000:(y_N4' = 0) & (p_N4' = newP_N4);
  // Level 2: 1 < newP_N4 <= 2 -> fire P=0.50
  [tick] newP_N4 > 1 & newP_N4 <= 2 -> 0.500000:(y_N4' = 1) & (p_N4' = 0) + 0.500000:(y_N4' = 0) & (p_N4' = newP_N4);
  // Level 3: 2 < newP_N4 <= 3 -> fire P=0.75
  [tick] newP_N4 > 2 & newP_N4 <= 3 -> 0.750000:(y_N4' = 1) & (p_N4' = 0) + 0.250000:(y_N4' = 0) & (p_N4' = newP_N4);
  // Level 4: newP_N4 > 3 -> certain fire
